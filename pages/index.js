...
export default function Home() {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags - CRITICAL for SEO */}
        <title>Dentics Moora | Family Dentist in Moora, WA | Book Online 24/7</title>
        <meta name="title" content="Dentics Moora | Family Dentist in Moora, WA | Book Online" />
        <meta
          name="description"
          content="Professional dental care in Moora, WA. Dr. Hosa Byun offers general dentistry, dental implants, cosmetic dentistry, and emergency care. AHPRA registered. Call 0424 000 442 to book."
        />
        <meta
          name="keywords"
          content="dentist Moora, dental clinic Moora WA, teeth cleaning Moora, dental implants Moora, emergency dentist Moora, family dentist Moora, affordable dentist Wheatbelt, Dr Hosa Byun, AHPRA dentist, cosmetic dentistry Moora"
        />

        {/* Canonical URL */}
        <link rel="canonical" href="https://dentics-moora-website.onrender.com/" />

        {/* Open Graph / Facebook */}
        <meta property="og:url" content="https://dentics-moora-website.onrender.com/" />
        <meta property="og:title" content="Dentics Moora | Family Dentist in Moora, WA" />
        <meta
          property="og:description"
          content="Professional dental care in Moora, WA. General dentistry, implants, cosmetic dentistry & emergency care. AHPRA registered. Call 0424 000 442."
        />
        <meta property="og:image" content="https://dentics-moora-website.onrender.com/og-image.jpg" />

        {/* Twitter */}
        <meta name="twitter:url" content="https://dentics-moora-website.onrender.com/" />
        <meta name="twitter:title" content="Dentics Moora | Family Dentist in Moora, WA" />
        <meta
          name="twitter:description"
          content="Professional dental care in Moora, WA. General dentistry, implants, cosmetic dentistry & emergency care."
        />
        <meta name="twitter:image" content="https://dentics-moora-website.onrender.com/og-image.jpg" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center gap-2">
                <svg className="h-8 w-8 text-blue-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <a
                    ...
                    aria-label="Call 0424 000 442 to book appointment"
                  >
                ...
                <div className="flex flex-wrap gap-6 pt-6">
                  <div className="flex items-center gap-2">
                    <svg className="h-5 w-5 text-blue-200" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <div className="flex items-center gap-2">
                    <svg className="h-5 w-5 text-yellow-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-slate-50 rounded-2xl p-8 lg:p-12">
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div className="space-y-2">
                      <h2 className="text-2xl font-bold text-slate-900">Dr. Hosa Byun</h2>
        ...
        <section id="services" className="py-20 lg:py-28 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <article className="bg-white border border-slate-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                <div className="text-4xl mb-3" role="img" aria-label="Tooth icon">🦷</div>
              ...
              <article className="bg-white border border-slate-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                <div className="text-4xl mb-3" role="img" aria-label="Sparkles icon">✨</div>
              ...
              <article className="bg-white border border-slate-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                <div className="text-4xl mb-3" role="img" aria-label="Crown icon">👑</div>
              ...
              <article className="bg-white border border-slate-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                <div className="text-4xl mb-3" role="img" aria-label="Tools icon">🔧</div>
              ...
              <article className="bg-white border border-slate-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                <div className="text-4xl mb-3" role="img" aria-label="Smile icon">😁</div>
              ...
              <article className="bg-white border border-slate-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                <div className="text-4xl mb-3" role="img" aria-label="Medical icon">💊</div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <article className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <div className="flex gap-1 mb-3" role="img" aria-label="5 out of 5 stars">
                  {[1,2,3,4,5].map(i => (
                    <svg key={i} className="h-4 w-4 text-yellow-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                    </svg>
                  ))}
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <time className="font-medium text-slate-900">9:00 AM - 5:00 PM</time>
                    </div>
              ...
              <div className="h-[600px] rounded-xl overflow-hidden shadow-lg">
                <iframe
                  ...
                  title="Dentics Moora Location - 394 Dandaragan Road, Moora, WA 6510"
                ></iframe>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-4 gap-8">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <svg className="h-8 w-8 text-blue-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                  </svg>
              ...
              <div>
                ...
                <address className="not-italic space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <svg className="h-4 w-4 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    </svg>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>Mon - Fri</span>
                    <time className="text-white">9:00 - 17:00</time>
                  </div>
                  <div className="flex justify-between">
                    <span>Saturday</span>
...
// This ensures the page is pre-rendered at build time for SEO
export async function getStaticProps() {
  return {
    props: {
      // Practice info could be fetched from a CMS or database
      // For now, it's hardcoded in the component
    },
